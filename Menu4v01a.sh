...
cd /home/administrator && mkdir /home/administrator/fstab;
          ...
          sudo x-terminal-emulator -e "bash -c \"cd /home/administrator/fstab; cd /home/administrator/fstab;touch /home/administrator/smbcredentials;read username password && sudo chmod 777 /home/administrator/fstab/smbcredentials; sudo echo "username=\$username " >> /home/administrator/fstab/smbcredentials;sudo echo "password=\${password} " >> /home/administrator/fstab/smbcredentials; exec bash \""
...
#x-terminal-emulator -e "bash -c \"read username password && sudo chmod 777 /home/administrator/fstab/smbcredentials && sudo echo "username = \$username " >> /home/administrator/fstab/smbcredentials && sudo echo "password = \${password} " >> /home/administrator/fstab/smbcredentials; exec bash \""
	...
	sudo x-terminal-emulator -e "bash -c \"cd /mnt/;sudo mkdir /mnt/windowsshare1;sudo ln -s /mnt/windowsshare1 /home/administrator/Desktop/ZDrive; exec bash \""             

	elif [ "$opt" = "9" ];then
             sudo x-terminal-emulator -e "bash -c \"sudo echo "//172.168.1.3/user /mnt/windowsshare1 cifs credentials=/home/administrator/fstab/smbcredentials,iocharset=utf8,_netdev,auto,dir_mode=0777,file_mode=0777 0 0" | sudo tee -a /etc/fstab;cd /home/administrator && mkdir /home/administrator/fstab;cd /home/administrator && mkdir /home/administrator/fstab; sudo x-terminal-emulator -e "bash -c \"cd /home/administrator/fstab; cd /home/administrator/fstab;touch /home/administrator/smbcredentials;read username password && sudo chmod 777 /home/administrator/fstab/smbcredentials; sudo echo "username=\$username " >> /home/administrator/fstab/smbcredentials;sudo echo "password=\${password} " >> /home/administrator/fstab/smbcredentials; cd /mnt/ && sudo mkdir /mnt/windowsshare1;cd /mnt/;sudo mkdir /mnt/windowsshare1;sudo ln -s /mnt/windowsshare1 /home/administrator/Desktop/ZDrive; exec bash \""     
	elif [ "$opt" = "10" ];then
             mainopt
	elif [ "$opt" = "11" ];then
             exit
